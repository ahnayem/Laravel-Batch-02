...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($feedback)) {
        ...
        if (!isset($feedbackData[$user_email])) {
            $feedbackData[$user_email] = [];
        }

        $feedbackData[$user_email][] = $feedback;

        file_put_contents($feedbackFile, json_encode($feedbackData, JSON_PRETTY_PRINT));
